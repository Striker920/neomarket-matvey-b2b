...
class TestInvoiceCreate:
    ...
    def test_create_invoice_with_moderated_sku_returns_201(self, client, db_session, valid_jwt_with_fixed_id):
        """Happy path: создание накладной с MODERATED SKU → 201, статус CREATED"""
        ...
        data = response.json()
        assert data["status"] == "CREATED"  # По спецификации OpenAPI
    ...
    def test_empty_items_returns_400(self, client, valid_jwt_with_fixed_id):
        """Empty items → 422 (Pydantic валидация min_length=1)"""
